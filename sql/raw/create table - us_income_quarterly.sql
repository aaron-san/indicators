...
DROP TABLE IF EXISTS us_income_quarterly;

-- Create the table structure
CREATE TABLE us_income_quarterly (
...
## SQL
## SQL
LOAD DATA LOCAL INFILE 'c:\\Users\\aaron\\Desktop\\Local Projects\\Portfolio Projects\\data\\SimFin\\us-income-quarterly\\us-income-quarterly.csv'
INTO TABLE us_income_quarterly
