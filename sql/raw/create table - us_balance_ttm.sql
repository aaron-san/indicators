...
DROP TABLE IF EXISTS us_balance_ttm;

-- Create the table structure

CREATE TABLE us_balance_ttm (
...
-- Upload the csv data
LOAD DATA LOCAL INFILE 'c:\\Users\\aaron\\Desktop\\Local Projects\\Portfolio Projects\\data\\SimFin\\us-balance-ttm\\us-balance-ttm.csv'
INTO TABLE us_balance_ttm
